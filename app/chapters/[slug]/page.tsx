...
export default async function ChapterDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <div className="space-y-8">
    ...
    <section className="card p-5"><h2 className="font-serifcn text-2xl font-bold text-paper">完整原文学习版</h2><p className="mt-4 whitespace-pre-line font-serifcn text-lg leading-loose text-paper/80">{chapter.fullOriginal}</p></section>
